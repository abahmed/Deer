...
| webpack                 | ^4.29.4   | A module bundler for JavaScript files |
...
| react                 | ^16.8.2       | A JavaScript library for building user interfaces |
| react-custom-scrollbars | ^4.2.1      | React scrollbars component |
| react-dom             | ^16.8.2       | React package for working with the DOM |
| react-i18next         | ^10.1.2       | Internationalization for react |
