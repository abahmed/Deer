...
| webpack                 | ^4.22.0   | A module bundler for JavaScript files |
...
| i18next               | ^11.10.1       | internationalization framework |
...
| react-i18next         | ^8.1.0        | Internationalization for react |
...
| redux-actions         | ^2.6.3        | Helpers for both handling and creating actions |
